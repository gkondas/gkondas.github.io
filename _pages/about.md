...
Hello! I am a full time research assistant at the Michigan AI lab working with Professor [Jenna Wiens](https://websites.umich.edu/~wiensj/). I am fortunate to have [Sarah Jabbour](https://sjabbour.github.io/) as an awesome mentor! My research focuses on **machine learning with applications in healthcare.** I am currently interested in **foundation models for electronic health record and physiological signal representation learning**, **medical time series analysis**, and **explainable AI**. I will soon be applying to Ph.D. programs with start dates in the fall of 2025. Here is my [CV](https://gkondas.github.io/files/gregCV.pdf).
